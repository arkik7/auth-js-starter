...
import { BriefcaseIcon, FlowerIcon, HeartIcon, LightbulbIcon, MountainSnow, SettingsIcon } from 'lucide-react';
    ...
    <div className="relative overflow-hidden">
      <div className="container py-24 lg:py-32">
        <div className="text-center">
          <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">Next.js Starter Template</h1>
          <p className="mt-3 text-xl text-muted-foreground">Powered by Auth.js</p>
