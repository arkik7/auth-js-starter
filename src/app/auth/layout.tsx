...
import LogoIpsum from '@/components/logos/logo-ipsum';
import RoundedPlaceholder from '@/components/logos/rounded-placeholder';
    ...
    <div className="relative bg-gradient-to-bl from-primary-foreground via-primary-foreground to-background">
      <div className="container py-24 sm:py-32">
          ...
          <div>
            ...
            <div className="mt-4 md:mb-12 max-w-2xl">
              <h1 className="mb-4 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                Quick Auth setup: Powered by Auth.js
              </h1>
              <p className="text-xl text-muted-foreground">
                Insert only couple of environment variables and your starter app is good to go.
              </p>
            </div>
            {/* End Title */}
            {/* Blockquote */}
            <blockquote className="hidden md:block relative max-w-sm">
              ...
              <div className="relative z-10">
                <p className="text-xl italic">Saves hours of setting up authentication.</p>
              </div>
              <footer className="mt-3">
                <div className="flex items-center">
                  ...
                  <div className="grow ms-4">
                    ...
                    <div className="text-xs text-muted-foreground">Happy CFO | Some cool company</div>
                  </div>
                </div>
              </footer>
            </blockquote>
        ...
        <div className="flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
          {logos.map((l) => (
            <React.Fragment key={l.id}>{l.logo}</React.Fragment>
          ))}
        </div>
        {/* End Clients */}
      </div>
